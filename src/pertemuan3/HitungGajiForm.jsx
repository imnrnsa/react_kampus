			...
			<div className="bg-white p-6 rounded-lg shadow-lg w-96">
				...
				<div className="mb-4">
                    ...
                    <div className="text-center text-gray-500">
                        Silakan masukkan jumlah gaji untuk menghitung gaji bersih.
                    </div>
                    <>
                        <div className="mb-4">
                            <label className="block text-gray-700 font-medium mb-1">
				...
				<div className="mt-4 p-3 bg-blue-100 border-l-4 border-blue-500 text-blue-700">
					<p className="font-semibold">
						Silahkan masukkan gajiyang valid (Tidak boleh kosong atau negatif).
					</p>
				</div>
                ) : (
				<div className="mt-4 p-3 bg-blue-100 border-l-4 border-blue-500 text-blue-700">
					<p className="font-semibold">
						Total Take Home Pay (THP): Rp {totalgaji.toLocalString()}
					</p>
				</div>
                )}
			</div>
